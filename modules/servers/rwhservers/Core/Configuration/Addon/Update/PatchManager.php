...
class PatchManager
{
    ...
    {
        $this->updatePath = ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . "app" . DIRECTORY_SEPARATOR . "Configuration" . DIRECTORY_SEPARATOR . "Addon" . DIRECTORY_SEPARATOR . "Update" . DIRECTORY_SEPARATOR . "Patch";
        $this->loadUpdatePath();
    }
