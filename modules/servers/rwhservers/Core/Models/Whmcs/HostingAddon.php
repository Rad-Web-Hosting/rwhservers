...
class HostingAddon extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\ProductsReseller\Server\rwhservers\Core\Models\Whmcs\Addon", "addonid");
    }

    public function hosting()
    {
        return $this->belongsTo("ModulesGarden\ProductsReseller\Server\rwhservers\Core\Models\Whmcs\Hosting", "hostingid");
    }
