...
class Upgrade extends EloquentModel
{
    ...
    {
        return $this->belongsTo("ModulesGarden\ProductsReseller\Server\rwhservers\Core\Models\Whmcs\Order", "orderid");
    }
    ...
    public function hosting()
    {
        ...
        return $this->belongsTo("ModulesGarden\ProductsReseller\Server\rwhservers\Core\Models\Whmcs\Hosting", "relid");
    }
    ...
    public function productFrom()
    {
        ...
        return $this->belongsTo("ModulesGarden\ProductsReseller\Server\rwhservers\Core\Models\Whmcs\Product", "originalvalue");
    }
