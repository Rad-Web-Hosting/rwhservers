...
namespace ModulesGarden\ProductsReseller\Server\rwhservers\Core\Queue\Services;


use ModulesGarden\ProductsReseller\Server\rwhservers\Core\Queue\Models\JobLog;
...
class Log
{
    ...
    public function __construct(\ModulesGarden\ProductsReseller\Server\rwhservers\Core\Queue\Models\Job $job)
    {
        $this->job = $job;
    }
