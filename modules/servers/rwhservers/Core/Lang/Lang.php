...
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\Models\Whmcs as wModels;
...
class Lang
{
    ...
    {
        $files = [
            $this->dir . DIRECTORY_SEPARATOR . $lang . '.php',
            $this->dir . DIRECTORY_SEPARATOR . 'overrides'. DIRECTORY_SEPARATOR. $lang . '.php',
        ];
