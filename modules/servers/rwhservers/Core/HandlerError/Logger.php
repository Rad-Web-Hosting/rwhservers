...
use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\Interfaces\LoggerInterface;
use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\HandlerError\ErrorCodes\ErrorCodesLib;
use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\HandlerError\Exceptions\Exception;
...
{
    /**
     * @var \ModulesGarden\ProductsReseller\Server\rwhservers\Core\HandlerError\Logger
     */
    ...
    {
//        $this->name     = $name;
//        $this->mainPath = ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . 'storage' . DIRECTORY_SEPARATOR . 'logs' . DS;
...
//        $this->addHandlerToLogger();
     ...
     * @return mixed
     * @throws \ModulesGarden\ProductsReseller\Server\rwhservers\Core\HandlerError\Exceptions\Exception
     */
     ...
     * @param string $warningName
     * @param string $errorName
     * @return \ModulesGarden\ProductsReseller\Server\rwhservers\Core\HandlerError\Logger
     */
