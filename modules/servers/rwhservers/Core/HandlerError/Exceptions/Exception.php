...
namespace ModulesGarden\ProductsReseller\Server\rwhservers\Core\HandlerError\Exceptions;
...
class Exception extends \Exception
{
     ...
     *
     * @var type \ModulesGarden\ProductsReseller\Server\rwhservers\Core\HandlerError\ErrorCodes\ErrorCode
     */
    ...
    public function isAdminLogedIn()
    {
        ...
        $adminId = $this->request->getSessionData('adminid');
