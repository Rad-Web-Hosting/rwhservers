...
namespace ModulesGarden\ProductsReseller\Server\rwhservers\Core\Cache;

use Symfony\Component\Cache\Simple\FilesystemCache;
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\ModuleConstants;
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\Interfaces\CacheManagerInterface;
...
class CacheManager implements CacheManagerInterface
{
    ...
    public function __construct()
    {
        ...
        $this->dir       = ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . 'storage' . DIRECTORY_SEPARATOR . 'framework';
    ...
    public function setKey($key = 'default')
    {
        ...
        {
            throw new \ModulesGarden\ProductsReseller\Server\rwhservers\Core\HandlerError\Exceptions\MGModuleException(self::class, $ex->getMessage(), $ex->getCode(), $ex);
        }
