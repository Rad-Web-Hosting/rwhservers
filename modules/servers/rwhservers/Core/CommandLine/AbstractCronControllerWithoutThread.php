...
use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\Models\CronTabs;
                    ...
                    while ($this->canRunScript())
                    {
                        if ($this->isChildrenCreate())
                        {
                            ...
                            foreach ($this->getIndexElements() as $key)
                            {
                                ...
                                exec($phpInterpreter . " " . ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . 'cron' . DIRECTORY_SEPARATOR . 'cron.php ' . $this->className
