...
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\Hook\Interfaces\InternalHook;
...
class InternalHooksWrapper
{
    ...
    {
        $fullInstanceName = '\ModulesGarden\ProductsReseller\Server\rwhservers\App\Hooks\InternalHooks\\' . $name;
