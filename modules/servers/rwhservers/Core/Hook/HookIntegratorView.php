...
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Controllers\Instances\Http\Integration;
...
class HookIntegratorView
{
    ...
    /**
     * @var null|string|\ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\View
     * integration data
     */
    protected $view = null;
    ...
    {
        if ($this->view instanceof \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\View)
        {
