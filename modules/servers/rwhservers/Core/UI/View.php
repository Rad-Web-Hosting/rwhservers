...
class View
{
     ...
     * @var \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\MainContainer
     */
    ...
    public function __construct($template = null)
    {
        ...
        $this->mainContainer = new \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\MainContainer();
    ...
    public function setTemplate($template = null)
    {
        if ($template === null)
        {
            ...
            $this->templateDir = ModuleConstants::getTemplateDir()
                                 . DIRECTORY_SEPARATOR . (Helper\isAdmin() ? TemplateConstants::ADMIN_PATH : TemplateConstants::CLIENT_PATH)
                                 . DIRECTORY_SEPARATOR . TemplateConstants::MAIN_DIR;
