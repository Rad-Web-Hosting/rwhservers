...
namespace ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Builder;
...
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\MainContainer;
...
class Context
{
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\Title;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\HtmlElements;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\Template;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\Searchable;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\Buttons;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\Icon;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\VueComponent;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\HtmlAttributes;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\ACL;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\CallBackFunction;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\Alerts;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\RefreshAction;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\WidgetView;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\RequestObjectHandler;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\AjaxComponent;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\ContainerElements;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\WhmcsParams;
    ...
    /**
     * @param \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Builder\Context $object
     * @return string
     */
