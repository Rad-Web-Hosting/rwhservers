...
namespace ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Helpers;
...
class BreadcrumbsHandler
{
    ...
    {
        $this->breadcrumbs[] = new \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Helpers\Breadcrumb(
    ...
    public function loadDefault()
    {
        ...
        $router = new \ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Controllers\Router();
        if ($this->isAdmin())
        {
