...
use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Builder\Config;
...
class MainContainerAjax extends MainContainer
{
    ...
    public function __construct($baseId = null)
    {
        ...
        $index = \ModulesGarden\ProductsReseller\Server\rwhservers\Core\Helper\sl('request')->get('index');
    ...
    public function addAjaxElement(\ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Interfaces\AjaxElementInterface &$element)
    {
        /**
         * @var Context $element
         */
