...
namespace ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Widget\DataTable;

use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Builder\BaseContainer;
use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Widget\DataTable\DataProviders;
 ...
 * @author inbs
 */
class DataTable extends BaseContainer implements \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Interfaces\AjaxElementInterface
{
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\DatatableActionButtons;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\DatatableMassActionButtons;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\VSortable;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\TitleButtons;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\TableLength;
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Traits\Datatable\Filters;
    ...
    */
    ...
    public function addButtonToDropdawn($button)
    {
        ...
        {
            $this->dropdawnWrapper = DependencyInjection::call(\ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Widget\Buttons\DropdawnButtonWrappers\ButtonDropdown::class);
