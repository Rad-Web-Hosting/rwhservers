...
class ButtonSwitchAjax extends ButtonCustomAction implements AjaxElementInterface
{
    ...
    {
        if ($model instanceof \ModulesGarden\ProductsReseller\Server\rwhservers\Core\Models\ExtendedEloquentModel || $model instanceof \Illuminate\Database\Eloquent\Model)
        {
