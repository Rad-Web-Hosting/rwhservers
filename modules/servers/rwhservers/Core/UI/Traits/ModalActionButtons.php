...
use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Widget\Buttons\ModalActionButtons\BaseAcceptButton;
use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Widget\Buttons\ModalActionButtons\BaseCancelButton;
...
trait ModalActionButtons
{
    ...
    protected function addButtonToList($button)
    {
        ...
        if (!isset($this->actionButtons[$id]))
        {
            ...
            if ($button instanceof \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Interfaces\AjaxElementInterface)
            {
