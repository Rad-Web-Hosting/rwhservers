...
trait Searchable
{
    ...
    public function insertSearchForm()
    {
        if ($this->searchable)
        {
            $searchForm = new \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\Searchable();
    ...
    public function insertHiddenSearchForm()
    {
        if ($this->searchable)
        {
            $searchForm = new \ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\HiddenSearchable();
