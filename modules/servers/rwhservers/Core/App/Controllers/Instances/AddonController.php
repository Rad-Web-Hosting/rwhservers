...
namespace ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Controllers\Instances;

use ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Controllers\Http\PageNotFound;
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Controllers\Interfaces\DefaultController;
...
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\ViewAjax;
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\UI\ViewIntegrationAddon;
...
abstract class AddonController implements DefaultController
{
    ...
    use \ModulesGarden\ProductsReseller\Server\rwhservers\Core\Traits\ErrorCodesLibrary;
    ...
    protected function getIntegrationControler($action = null)
    {
        ...
        {
            case 'ConfigOptions':
                return Helper\di(\ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Controllers\Instances\Http\ConfigOptionsIntegration::class);
                break;
            case 'AdminServicesTabFields':
                return Helper\di(\ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Controllers\Instances\Http\AdminServicesTabFieldsIntegration::class);
                break;
            default:
                return Helper\di(\ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Controllers\Instances\Http\AddonIntegration::class);
        }
    }
