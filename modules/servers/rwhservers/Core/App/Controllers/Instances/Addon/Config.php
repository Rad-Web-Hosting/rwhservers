...
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\Configuration\Data;
 ...
 */
class Config extends \ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Controllers\Instances\AddonController implements AddonController
{
    /**
     * @var array
    ...
    /**
     * @var null|\ModulesGarden\ProductsReseller\Server\rwhservers\Core\Configuration\Data
     *
     */
    protected $data = null;
    ...
    public function getConfig()
    {
        ...
        try
        {
            ...
            $params = [];
            $return = ServiceLocator::call(\ModulesGarden\ProductsReseller\Server\rwhservers\Core\Configuration\Addon\Config\Before::class)->execute($params);
            ...
            $return = ServiceLocator::call(\ModulesGarden\ProductsReseller\Server\rwhservers\Core\Configuration\Addon\Config\After::class)->execute($return);
