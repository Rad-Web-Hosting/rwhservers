...
use ModulesGarden\ProductsReseller\Server\rwhservers\Core\FileReader\Directory;
...
class PackageManager
{
    ...
    public function getPackageListByDirectory()
    {
        ...
        {
            $className = '\ModulesGarden\ProductsReseller\Server\rwhservers\Packages\\' . $packageName . '\Config\PackageConfiguration';
