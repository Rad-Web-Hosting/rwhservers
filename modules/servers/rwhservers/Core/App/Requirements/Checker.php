...
namespace ModulesGarden\ProductsReseller\Server\rwhservers\Core\App\Requirements;
...
{
    /**
     * \ModulesGarden\ProductsReseller\Server\rwhservers\Core\FileReader\PathValidator
     * @var type null|\ModulesGarden\ProductsReseller\Server\rwhservers\Core\FileReader\|\ModulesGarden\ProductsReseller\Server\rwhservers\Core\FileReader\Directory
     */
    ...
    {
        $this->directoryHandler = new \ModulesGarden\ProductsReseller\Server\rwhservers\Core\FileReader\Directory();
    ...
    {
        $fullPath       = \ModulesGarden\ProductsReseller\Server\rwhservers\Core\ModuleConstants::getModuleRootDir() . DIRECTORY_SEPARATOR . $path;
    ...
    protected function checkRequirements()
    {
        ...
        {
            $instance = \ModulesGarden\ProductsReseller\Server\rwhservers\Core\DependencyInjection\DependencyInjection::call($requirement);
