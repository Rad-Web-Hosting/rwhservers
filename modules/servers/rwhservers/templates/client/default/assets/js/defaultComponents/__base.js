...
const productsResellerAppLoader = function (event) {
    if (document.readyState === "complete" || document.readyState === "interactive")
    {
        document.removeEventListener('readystatechange', productsResellerAppLoader);
        mgLoadPageContoler();
    }
}
...
{
    productsResellerAppLoader({
        readyState: document.readyState
    });
}
else
{
    document.addEventListener('readystatechange', productsResellerAppLoader);
}
